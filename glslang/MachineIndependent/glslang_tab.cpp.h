...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    DOT = 635,                     /* DOT  */
    ELLIPSIS = 636,                /* ELLIPSIS  */
    COMMA = 637,                   /* COMMA  */
    COLON = 638,                   /* COLON  */
    EQUAL = 639,                   /* EQUAL  */
    SEMICOLON = 640,               /* SEMICOLON  */
    BANG = 641,                    /* BANG  */
    DASH = 642,                    /* DASH  */
    TILDE = 643,                   /* TILDE  */
    PLUS = 644,                    /* PLUS  */
    ...
    SLASH = 646,                   /* SLASH  */
    PERCENT = 647,                 /* PERCENT  */
    LEFT_ANGLE = 648,              /* LEFT_ANGLE  */
    RIGHT_ANGLE = 649,             /* RIGHT_ANGLE  */
    VERTICAL_BAR = 650,            /* VERTICAL_BAR  */
    CARET = 651,                   /* CARET  */
    AMPERSAND = 652,               /* AMPERSAND  */
    QUESTION = 653,                /* QUESTION  */
    INVARIANT = 654,               /* INVARIANT  */
    HIGH_PRECISION = 655,          /* HIGH_PRECISION  */
    MEDIUM_PRECISION = 656,        /* MEDIUM_PRECISION  */
    LOW_PRECISION = 657,           /* LOW_PRECISION  */
    PRECISION = 658,               /* PRECISION  */
    PACKED = 659,                  /* PACKED  */
    RESOURCE = 660,                /* RESOURCE  */
    SUPERP = 661,                  /* SUPERP  */
    FLOATCONSTANT = 662,           /* FLOATCONSTANT  */
    INTCONSTANT = 663,             /* INTCONSTANT  */
    UINTCONSTANT = 664,            /* UINTCONSTANT  */
    BOOLCONSTANT = 665,            /* BOOLCONSTANT  */
    IDENTIFIER = 666,              /* IDENTIFIER  */
    TYPE_NAME = 667,               /* TYPE_NAME  */
    CENTROID = 668,                /* CENTROID  */
    IN = 669,                      /* IN  */
    OUT = 670,                     /* OUT  */
    INOUT = 671,                   /* INOUT  */
    STRUCT = 672,                  /* STRUCT  */
    ...
    CASE = 684,                    /* CASE  */
    DEFAULT = 685,                 /* DEFAULT  */
    TERMINATE_INVOCATION = 686,    /* TERMINATE_INVOCATION  */
    TERMINATE_RAY = 687,           /* TERMINATE_RAY  */
    IGNORE_INTERSECTION = 688,     /* IGNORE_INTERSECTION  */
    UNIFORM = 689,                 /* UNIFORM  */
    SHARED = 690,                  /* SHARED  */
    BUFFER = 691,                  /* BUFFER  */
    TILEIMAGEEXT = 692,            /* TILEIMAGEEXT  */
    FLAT = 693,                    /* FLAT  */
    SMOOTH = 694,                  /* SMOOTH  */
    LAYOUT = 695,                  /* LAYOUT  */
    DOUBLECONSTANT = 696,          /* DOUBLECONSTANT  */
    INT16CONSTANT = 697,           /* INT16CONSTANT  */
    UINT16CONSTANT = 698,          /* UINT16CONSTANT  */
    FLOAT16CONSTANT = 699,         /* FLOAT16CONSTANT  */
    INT32CONSTANT = 700,           /* INT32CONSTANT  */
    UINT32CONSTANT = 701,          /* UINT32CONSTANT  */
    INT64CONSTANT = 702,           /* INT64CONSTANT  */
    UINT64CONSTANT = 703,          /* UINT64CONSTANT  */
    SUBROUTINE = 704,              /* SUBROUTINE  */
    DEMOTE = 705,                  /* DEMOTE  */
    FUNCTION = 706,                /* FUNCTION  */
    PAYLOADNV = 707,               /* PAYLOADNV  */
    PAYLOADINNV = 708,             /* PAYLOADINNV  */
    HITATTRNV = 709,               /* HITATTRNV  */
    CALLDATANV = 710,              /* CALLDATANV  */
    CALLDATAINNV = 711,            /* CALLDATAINNV  */
    PAYLOADEXT = 712,              /* PAYLOADEXT  */
    PAYLOADINEXT = 713,            /* PAYLOADINEXT  */
    HITATTREXT = 714,              /* HITATTREXT  */
    CALLDATAEXT = 715,             /* CALLDATAEXT  */
    CALLDATAINEXT = 716,           /* CALLDATAINEXT  */
    PATCH = 717,                   /* PATCH  */
    SAMPLE = 718,                  /* SAMPLE  */
    NONUNIFORM = 719,              /* NONUNIFORM  */
    RESOURCEHEAP = 720,            /* RESOURCEHEAP  */
    SAMPLERHEAP = 721,             /* SAMPLERHEAP  */
    COHERENT = 722,                /* COHERENT  */
    VOLATILE = 723,                /* VOLATILE  */
    RESTRICT = 724,                /* RESTRICT  */
    READONLY = 725,                /* READONLY  */
    WRITEONLY = 726,               /* WRITEONLY  */
    NONTEMPORAL = 727,             /* NONTEMPORAL  */
    DEVICECOHERENT = 728,          /* DEVICECOHERENT  */
    QUEUEFAMILYCOHERENT = 729,     /* QUEUEFAMILYCOHERENT  */
    WORKGROUPCOHERENT = 730,       /* WORKGROUPCOHERENT  */
    SUBGROUPCOHERENT = 731,        /* SUBGROUPCOHERENT  */
    NONPRIVATE = 732,              /* NONPRIVATE  */
    SHADERCALLCOHERENT = 733,      /* SHADERCALLCOHERENT  */
    NOPERSPECTIVE = 734,           /* NOPERSPECTIVE  */
    EXPLICITINTERPAMD = 735,       /* EXPLICITINTERPAMD  */
    PERVERTEXEXT = 736,            /* PERVERTEXEXT  */
    PERVERTEXNV = 737,             /* PERVERTEXNV  */
    PERPRIMITIVENV = 738,          /* PERPRIMITIVENV  */
    PERVIEWNV = 739,               /* PERVIEWNV  */
    PERTASKNV = 740,               /* PERTASKNV  */
    PERPRIMITIVEEXT = 741,         /* PERPRIMITIVEEXT  */
    TASKPAYLOADWORKGROUPEXT = 742, /* TASKPAYLOADWORKGROUPEXT  */
    PRECISE = 743                  /* PRECISE  */
  };
...
#line 591 "MachineIndependent/glslang_tab.cpp.h"
