...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    SPIRV_STRING = 604,            /* SPIRV_STRING  */
    ATTACHMENTEXT = 605,           /* ATTACHMENTEXT  */
    IATTACHMENTEXT = 606,          /* IATTACHMENTEXT  */
    UATTACHMENTEXT = 607,          /* UATTACHMENTEXT  */
    LEFT_OP = 608,                 /* LEFT_OP  */
    RIGHT_OP = 609,                /* RIGHT_OP  */
    INC_OP = 610,                  /* INC_OP  */
    DEC_OP = 611,                  /* DEC_OP  */
    LE_OP = 612,                   /* LE_OP  */
    GE_OP = 613,                   /* GE_OP  */
    ...
    OR_OP = 617,                   /* OR_OP  */
    XOR_OP = 618,                  /* XOR_OP  */
    MUL_ASSIGN = 619,              /* MUL_ASSIGN  */
    DIV_ASSIGN = 620,              /* DIV_ASSIGN  */
    ADD_ASSIGN = 621,              /* ADD_ASSIGN  */
    MOD_ASSIGN = 622,              /* MOD_ASSIGN  */
    LEFT_ASSIGN = 623,             /* LEFT_ASSIGN  */
    RIGHT_ASSIGN = 624,            /* RIGHT_ASSIGN  */
    AND_ASSIGN = 625,              /* AND_ASSIGN  */
    XOR_ASSIGN = 626,              /* XOR_ASSIGN  */
    OR_ASSIGN = 627,               /* OR_ASSIGN  */
    SUB_ASSIGN = 628,              /* SUB_ASSIGN  */
    STRING_LITERAL = 629,          /* STRING_LITERAL  */
    LEFT_PAREN = 630,              /* LEFT_PAREN  */
    RIGHT_PAREN = 631,             /* RIGHT_PAREN  */
    LEFT_BRACKET = 632,            /* LEFT_BRACKET  */
    RIGHT_BRACKET = 633,           /* RIGHT_BRACKET  */
    LEFT_BRACE = 634,              /* LEFT_BRACE  */
    RIGHT_BRACE = 635,             /* RIGHT_BRACE  */
    DOT = 636,                     /* DOT  */
    ELLIPSIS = 637,                /* ELLIPSIS  */
    COMMA = 638,                   /* COMMA  */
    COLON = 639,                   /* COLON  */
    EQUAL = 640,                   /* EQUAL  */
    SEMICOLON = 641,               /* SEMICOLON  */
    BANG = 642,                    /* BANG  */
    DASH = 643,                    /* DASH  */
    TILDE = 644,                   /* TILDE  */
    PLUS = 645,                    /* PLUS  */
    ...
    SLASH = 647,                   /* SLASH  */
    PERCENT = 648,                 /* PERCENT  */
    LEFT_ANGLE = 649,              /* LEFT_ANGLE  */
    RIGHT_ANGLE = 650,             /* RIGHT_ANGLE  */
    VERTICAL_BAR = 651,            /* VERTICAL_BAR  */
    CARET = 652,                   /* CARET  */
    AMPERSAND = 653,               /* AMPERSAND  */
    QUESTION = 654,                /* QUESTION  */
    INVARIANT = 655,               /* INVARIANT  */
    HIGH_PRECISION = 656,          /* HIGH_PRECISION  */
    MEDIUM_PRECISION = 657,        /* MEDIUM_PRECISION  */
    LOW_PRECISION = 658,           /* LOW_PRECISION  */
    PRECISION = 659,               /* PRECISION  */
    PACKED = 660,                  /* PACKED  */
    RESOURCE = 661,                /* RESOURCE  */
    SUPERP = 662,                  /* SUPERP  */
    FLOATCONSTANT = 663,           /* FLOATCONSTANT  */
    INTCONSTANT = 664,             /* INTCONSTANT  */
    UINTCONSTANT = 665,            /* UINTCONSTANT  */
    BOOLCONSTANT = 666,            /* BOOLCONSTANT  */
    IDENTIFIER = 667,              /* IDENTIFIER  */
    TYPE_NAME = 668,               /* TYPE_NAME  */
    CENTROID = 669,                /* CENTROID  */
    IN = 670,                      /* IN  */
    OUT = 671,                     /* OUT  */
    INOUT = 672,                   /* INOUT  */
    STRUCT = 673,                  /* STRUCT  */
    ...
    CASE = 685,                    /* CASE  */
    DEFAULT = 686,                 /* DEFAULT  */
    TERMINATE_INVOCATION = 687,    /* TERMINATE_INVOCATION  */
    TERMINATE_RAY = 688,           /* TERMINATE_RAY  */
    IGNORE_INTERSECTION = 689,     /* IGNORE_INTERSECTION  */
    UNIFORM = 690,                 /* UNIFORM  */
    SHARED = 691,                  /* SHARED  */
    BUFFER = 692,                  /* BUFFER  */
    TILEIMAGEEXT = 693,            /* TILEIMAGEEXT  */
    FLAT = 694,                    /* FLAT  */
    SMOOTH = 695,                  /* SMOOTH  */
    LAYOUT = 696,                  /* LAYOUT  */
    DOUBLECONSTANT = 697,          /* DOUBLECONSTANT  */
    INT16CONSTANT = 698,           /* INT16CONSTANT  */
    UINT16CONSTANT = 699,          /* UINT16CONSTANT  */
    FLOAT16CONSTANT = 700,         /* FLOAT16CONSTANT  */
    INT32CONSTANT = 701,           /* INT32CONSTANT  */
    UINT32CONSTANT = 702,          /* UINT32CONSTANT  */
    INT64CONSTANT = 703,           /* INT64CONSTANT  */
    UINT64CONSTANT = 704,          /* UINT64CONSTANT  */
    SUBROUTINE = 705,              /* SUBROUTINE  */
    DEMOTE = 706,                  /* DEMOTE  */
    FUNCTION = 707,                /* FUNCTION  */
    PAYLOADNV = 708,               /* PAYLOADNV  */
    PAYLOADINNV = 709,             /* PAYLOADINNV  */
    HITATTRNV = 710,               /* HITATTRNV  */
    CALLDATANV = 711,              /* CALLDATANV  */
    CALLDATAINNV = 712,            /* CALLDATAINNV  */
    PAYLOADEXT = 713,              /* PAYLOADEXT  */
    PAYLOADINEXT = 714,            /* PAYLOADINEXT  */
    HITATTREXT = 715,              /* HITATTREXT  */
    CALLDATAEXT = 716,             /* CALLDATAEXT  */
    CALLDATAINEXT = 717,           /* CALLDATAINEXT  */
    PATCH = 718,                   /* PATCH  */
    SAMPLE = 719,                  /* SAMPLE  */
    NONUNIFORM = 720,              /* NONUNIFORM  */
    RESOURCEHEAP = 721,            /* RESOURCEHEAP  */
    SAMPLERHEAP = 722,             /* SAMPLERHEAP  */
    COHERENT = 723,                /* COHERENT  */
    VOLATILE = 724,                /* VOLATILE  */
    RESTRICT = 725,                /* RESTRICT  */
    READONLY = 726,                /* READONLY  */
    WRITEONLY = 727,               /* WRITEONLY  */
    NONTEMPORAL = 728,             /* NONTEMPORAL  */
    DEVICECOHERENT = 729,          /* DEVICECOHERENT  */
    QUEUEFAMILYCOHERENT = 730,     /* QUEUEFAMILYCOHERENT  */
    WORKGROUPCOHERENT = 731,       /* WORKGROUPCOHERENT  */
    SUBGROUPCOHERENT = 732,        /* SUBGROUPCOHERENT  */
    NONPRIVATE = 733,              /* NONPRIVATE  */
    SHADERCALLCOHERENT = 734,      /* SHADERCALLCOHERENT  */
    NOPERSPECTIVE = 735,           /* NOPERSPECTIVE  */
    EXPLICITINTERPAMD = 736,       /* EXPLICITINTERPAMD  */
    PERVERTEXEXT = 737,            /* PERVERTEXEXT  */
    PERVERTEXNV = 738,             /* PERVERTEXNV  */
    PERPRIMITIVENV = 739,          /* PERPRIMITIVENV  */
    PERVIEWNV = 740,               /* PERVIEWNV  */
    PERTASKNV = 741,               /* PERTASKNV  */
    PERPRIMITIVEEXT = 742,         /* PERPRIMITIVEEXT  */
    TASKPAYLOADWORKGROUPEXT = 743, /* TASKPAYLOADWORKGROUPEXT  */
    PRECISE = 744                  /* PRECISE  */
  };
...
#line 592 "MachineIndependent/glslang_tab.cpp.h"
